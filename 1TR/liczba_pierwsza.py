...
if licznik_dzielnikow > 0:
    print(f'Liczba {liczba_pierwsza} NIE  jest liczbą pierwszą . Liczba dzielnikow {licznik_dzielnikow}')
else:
    print(f'Liczba {liczba_pierwsza}  jest liczbą pierwszą . Liczba dzielnikow {licznik_dzielnikow}')
